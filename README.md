...
`git clone https://github.com/Heartless75/LEGENDUSERBOT.git`
- Open Cloned Folder.
...
Poject [LEGENDBOT](https://github.com/Heartless75/LEGENDBOT) is free software: you can redistribute it and/or modify
